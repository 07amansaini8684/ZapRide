...
const RideCard = ({
  ...
  return (
    <View className="flex flex-row items-center justify-center bg-white rounded-lg shadow-sm shadow-neutral-300 mb-3 p-2">
      <View className="flex flex-col items-start justify-center p-6">
